        ...
        <div className="flex flex-col gap-8">
          {loading
            ? Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="bg-[#0a0a0a] rounded-2xl border border-white/10 p-8 shadow-[0_0_15px_rgba(0,0,0,0.5)] flex flex-col md:flex-row gap-6">
            ...
            : doctors.map((doctor) => {
                return (
                  <div
                    key={doctor.id}
                    className="bg-[#0a0a0a] rounded-2xl border border-white/10 p-8 hover:border-cyan-500/50 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:shadow-[0_0_20px_rgba(0,240,255,0.15)] flex flex-col md:flex-row gap-8 items-center md:items-stretch group"
                  >
                    {/* Left: Info */}
                    <div className="flex-1">
                      ...
                      <div className="mb-6">
                        ...
                        <p className="text-slate-400 leading-relaxed pl-6 border-l-2 border-white/10 group-hover:border-blue-500/50 transition-colors">
                      ...
                      <div className="flex flex-wrap items-center gap-6 mt-auto">
                        <div className="flex items-center gap-2 text-slate-300 bg-white/5 border border-white/5 px-3 py-1.5 rounded-md backdrop-blur-sm">
                    ...
                    {/* Right: CTA */}
                    <div className="w-full md:w-56 flex flex-col justify-center border-t md:border-t-0 md:border-l border-white/10 pt-6 md:pt-0 md:pl-8 group-hover:border-cyan-500/20 transition-colors">
                      <Link 
                        href="/booking" 
                        className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white py-4 rounded-lg font-semibold hover:bg-blue-500 transition-all duration-300 shadow-[0_0_20px_rgba(0,68,255,0.4)] hover:shadow-[0_0_25px_rgba(0,240,255,0.6)]"
                      >
